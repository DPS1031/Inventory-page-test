...
namespace Lib_comunicaciones
{
    public class Comunicaciones
    {
        ...
        public async Task<Dictionary<string, object>> Execute(Dictionary<string, object> datos, string Usuario= null)
        {
            ...
            try
            {
                ...
                httpClient.DefaultRequestHeaders.Add("Usuario", Usuario);
